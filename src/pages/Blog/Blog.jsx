...
const Blog = () => {
    ...
    return (
        <>
            <div className='d-flex justify-content-between align-items-center BlogHeader'>
            ...
            <div className='container-fluid py-5'>
                <Card className='card card-hover mb-5'>
                    <Card.Header className='colorBG px-5 fw-bold text-white'>Software and Developer World </Card.Header>
                    <Card.Body>
                            ...
                            <div key={blog.id}>
                                <div className='row py-2'>
                                    ...
                                    <div className='col-sm-3 blogsAuthor-Date'>
                                        ...
                                        <Card.Text className='fw-semibold colorTxt'>
                ...
                <Card className='card card-hover mb-5'>
                    <Card.Header className='colorBG px-5 fw-bold text-white'>Web Security </Card.Header>
                    <Card.Body>
